...
const weeksPerMonth = [4, 4, 4, 5, 4, 5, 4, 4, 5, 4, 5, 4]; // Adjusted for a 52-week year
...
const Month = ({ name, weeks, startWeek }) => {
  ...
  return (
    <div style={{ width: monthWidth, marginRight: 8 }}>
...
const GitHubCommitsGrid = () => {
  return (
    <div className="overflow-x-auto p-4 bg-white dark:bg-gray-900 rounded-md shadow-md">
      <div
        className="flex"
        style={{
          alignItems: "flex-start",
          minWidth: "700px", // Ensures proper grid width for scrolling
        }}
      >
