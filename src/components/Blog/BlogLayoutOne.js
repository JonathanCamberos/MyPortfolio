...
const BlogLayoutOne = ({ blog }) => {
  return (
    <div className="group inline-block overflow-hidden rounded-xl relative">
      ...
      {/* Wrap image + shadow inside Link */}
      <Link href={blog.url} className="block w-full h-full relative rounded-xl overflow-hidden">
        
        {/* Shadow Div for Image */}
        <div
          className="absolute top-0 left-0 bottom-0 right-0 h-full
          bg-gradient-to-b from-transparent to-dark/40 rounded-xl z-10"
        />
        ...
        <Image
          ...
          sizes='(max-width: 1125px) 100vw, 50vw'
        />
      </Link>
