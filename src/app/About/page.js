    ...
    >
      <div className="max-w-5xl w-full">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg mb-6">I am currently working as a Software Engineer at Bank of America.</p>
          <p className="text-lg mb-6">In the past, I’ve interned at:</p>
          <ul className="list-disc pl-6 space-y-2">
            <li className="text-accent dark:text-accentDark">(2023) Bank of America</li>
            <li className="text-accent dark:text-accentDark">(2022) PwC</li>
          </ul>
        </div>
      </div>
    </section>
