...
# TODO: Exercise: Episode 1 Scales on the Blues, 01/23/25
Pg 1-8
...
# Filling Knowledge: All 12 Keys, instant
Pg 8-20

Practice writing out major and minor scale.

Note:
Goal i sto think in both keys at the same time. Since 
they are really the 'same key' just transposed +/- a half step.

# Practice: Augmented/Diminished Scales and Triangles
Pg 21-27
...
# Diagram: Rotating Kansas and Watering Pipes 
Pg 28-29

Failed attempt at guitar fret board lol.

Retrospect:
Found a better diagram, but this still has a funny name.
The watering piper portion is still good to look at.

# Filling Knowledge Gap: All 12 Notes on All Positions On Fretboard
Pg 30-49

# Pattern: Fretboard as Shifting Array, Circles, Triangles, Trapezoids and Other Shapes
Pg 50-65

Note:
You can actually map a 6x5 portion of the fretboard, memorize that, 
and just shift it over the fretboard to know where octaves all locally,
and use the hieroglyphs for global octaves.
Local diagram in book 5

# Pattern: Note Cards -> Note Fret Number Memorization
Pg 66-67

Note:
Created note cards to visualize shapes of notes. See note cards.

Note:
Memorize the open strings, and their shapes.


# Practice: Pre Hieroglyphs
Pg 68-71 

Repetition of Hieroglyphs.

# Practice: Black Box Trapezoid diagrams
Pg 72 

# TODO: Copy Black Box and Brute Force '4' To Note Cards
Pg 73 

Todo: 
not sure which this refers to, need to check naming scheme and cross reference.

# Practice: Hieroglyphs, Diminished Triangles, Trapezoids
Pg 74-77

# Pattern: Chords Within Hieroglyphs
Pg 78-80

Note:
Within the hieroglyphs, you can outline the basic E, G, C, D, etc chords. The
hieroglyphs explain the 'why' as to where they come from.