...
## Solution 1: [Monotonic Pointers] 2 Inner/Outer Pointers Traversal Creating Bound Buckets By Monotonic Opposite Ends Pointer Shift Modification - Two Pointers/K Pointer Variants
```python
    def trap(self, height: List[int]) -> int:
