...
```python
    def encode(self, strs: List[str]) -> str:
        ...
        # creates new string time complexity o(n^2)
...
### Solution 2: One Pointer Arithmetic Delimiter - Two Pointers/One Pointer with Auxiliary State
```python
    def encode(self, strs: List[str]) -> str:
    ...
    def decode(self, encoded: str) -> List[str]:
        ...
        while left < len(encoded):
            ...
            # extract substring of 'length' characters
            # time complexity: 
            substring = []
...
### Solution 1: Binary Search for Complement - Two Pointers/One Pointer with Auxiliary State
```python 
    def twoSumII(self, numbers: List[int], target: int) -> List[int]:
...
### Solution 2: Shift Pointer Ends Based on Sum - Two Pointers/Opposite Ends
```python
    def twoSumII(self, numbers: List[int], target: int) -> List[int]:
