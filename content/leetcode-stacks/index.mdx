...
```python
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        # where dp[n] is the list of all valid parenthesis combinations for some n pairs
        ...
        for i in range(1, n + 1): 
            ...
            # grab saved list of valid parentheses for 0 -> i
            for j in range(i):  

                # Setup: Two Pointer Variation: Opposite Ends

                # forward iteration over valid combination of parentheses for level j
                # start: 0 parentheses pairs
                for left in dp[j]:

                    # reverse iteration over valid combination of parentheses for level (i - 1 - j)
                    # start: i-1 parentheses pairs
                    for right in dp[i - 1 - j]:
                        ...
                        # Since we are doing Opposite Ends
