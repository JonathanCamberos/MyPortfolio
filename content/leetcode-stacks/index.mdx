...
### Solution 1: Stack (redundant operations - Stack/ Tracking Nested or Hierarchical Structures 
```python
    def isValid(self, s: str) -> bool:
...
### Solution 2: Stack - Stack/ Tracking Nested or Hierarchical Structures
```python
    def isValid(self, s: str) -> bool:
