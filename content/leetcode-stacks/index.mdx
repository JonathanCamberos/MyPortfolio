...
```python
    def generateParenthesis(self, n: int) -> List[str]:
        ...
        # Note:
        # This dynamic programming approach builds the result bottom-up,
        # constructing valid parentheses combinations by combining smaller subproblems.
        # It uses the mathematical structure of the problem (Catalan numbers),
        # assembling sequences with a formula based on previously computed results.
        # This avoids recursion but incurs overhead from nested loops and string concatenation.
