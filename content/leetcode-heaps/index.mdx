...
class Twitter:
    ...
    def __init__(self):
        ...
        # IRL Use Case: Balanced usage scenario users follow moderate number of accounts, tweet counts are not huge.
...
class TweetNode:
    ...
    # IRL Use Case: 'Celebrity' users with many tweets; avoids indexing overhead when fetching top 10.    
...
class Twitter:
    ...
    def __init__(self):
        ...
        # IRL Use Case: Most practical for IRL apps where MOST users have few tweets and follow a manageable number of accounts.
