...
### Solution 1: Hashmap Into BucketSort - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k:int) -> List[int]:
...
### Solution 2: MinHeap - HashMap/Algorithm
```python    
    def topKFrequent(self, nums: List[int], k:int) -> List[int]:
...
### Solution 3: Quickselect (high to low) - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
...
### Solution 4: Quickselect (low to high) - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
...
### Solution 5. Modified MergeSort Frequency Count - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        def mergeFrequencies(left_freq, right_freq):
            # Combine two frequency maps
        ...
        def modiMergeSort(nums):
            # Base case: Single element array
            if len(nums) == 1:
                return countFrequencies(nums)
            
            # Split the array into two halves
            mid = len(nums) // 2
            left_freq = modiMergeSort(nums[:mid])
            right_freq = modiMergeSort(nums[mid:])
            
            # Combine frequency counts from both halves
            return mergeFrequencies(left_freq, right_freq)
        
        # Step 1: Get frequency counts using divide and conquer
        freq = modiMergeSort(nums)
        ...
        return [item for item, _ in freq_items[:k]]
```
|  Aspect  | Time Complexity | Space Complexity |  Time Remarks | Space Remarks |
| -------- | --------------- | ---------------- | ------------- |  ------------ |
|  |  |  |  |  |
...
### Solution 1:  Prefix & Postfix 3 arrays O(n) - Array/In-place Transformations
```python
    def productExceptSelf(self, nums: List[int]) -> List[int]:
...
### Solution 2: Prefix & Postfix Optimal O(1) space - Array/In-place Transformations
```python
    def productExceptSelf(self, nums: List[int]) -> List[int]:
...
### Solution 3: Union Find Tree - Tree/Union Find
```python
    def longestConsecutive(self, nums: List[int]) -> int:
