...
```python
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        # this simulates a hashing into a dictionary
...
### Solution 1: MaxHeap O(n) - HashMap/Algorithm
```python    
    def topKFrequent(self, nums: List[int], k:int) -> List[int]:
        ...
        # space complexity: maxHeap tracks order of most frequent elements
        maxHeap = []

        # Push all elements into heap (negated frequency to simulate max heap)
...
### Solution 2: MinHeap O(k) - HashMap/Algorithm
```python    
    def topKFrequent(self, nums: List[int], k:int) -> List[int]:
...
### Solution 3: High K Quickselect - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
...
### Solution 4: Low K Quickselect - Hashmap/Algorithm
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
