...
If the table is resized to 2n, it can accomodate (2n * 0.75) - n more elements, or:
...
Due to their quick O(1) average time for insert(), lookup(), and delete(), they are great for storing key pairs of lists of elements 
to perform more complex tasks. 

This is commonly the first step of learning a 'leetcode' mindset
for performance where both time complexity and space complextiy are important.
