...
## Solution 1: DefaultDict Matrix With // Floor Division For (r,c) Tuple Key For Grid - Hashmap/Representation
```python 
    def isValidSudoku(self, board: List[List[str]]) -> bool:
...
## Solution 2: [[]] Matrix With // Floor Division To Get 9 Integer Indexing Options [TC Opt] - Hashmap/Representation
```python
    def isValidSudoku(self, board: List[List[str]]) -> bool:
        ...
        # For larger use cases, dictionary would be more optimal.
