...
| ------------------- | ----------------- | ------ | ---- |  --- |
| Brute Force | O(n log n) | O(n) | Sorting the strings involves recursively dividing the input and merging them back. Merge sort explanation [here](/blogs/common-formulas#merge-sort). | Temporary arrays are used during merging, leading to O(n) space |
