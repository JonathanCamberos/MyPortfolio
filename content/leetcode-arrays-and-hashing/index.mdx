...
### Solution 2: Hashmap (array of 26) - Hashmap/Representation
```python
    def isAnagram(self, s: str, t: str) -> bool:
...
### Solution 1: Hashmap Array of 26 to Tuple Key - Hashmap/Grouping by Criteria
```python
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
...
### Solution 2: Hashmap Array of 26 to String Key - Hashmap/Grouping by Criteria
```python
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
...
### Solution 1: Hashmap Into Bucket Sort - Hashmap/Grouping by Criteria - Algorithm/Specific
...
### Solution 2: MinHeap - Tree/MinHeap
```python    
    def topKFrequent(self, nums: List[int], k:int) -> List[int]:
...
### Solution 3: Quickselect (high to low) - Algorithm/Specific
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
...
### Solution 4: Quickselect (low to high) - Algorithm/Specific
```python
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
...
### Solution 1.1: Defaultdict Matrix - Hashmap/Representation
```python 
    def isValidSudoku(self, board: List[List[str]]) -> bool:
...
### Solution 1.2: [[]] Matrix - Hashmap/Representation
```python
    def isValidSudoku(self, board: List[List[str]]) -> bool:
