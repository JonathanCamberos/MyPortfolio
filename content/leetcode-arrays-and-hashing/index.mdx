...
When outer loop starts at index i = 0, inner loop iterates (n-1) times.

When outer loop starts at index i = 1, inner loop iterates (n-2) times.

When outer loop starts at index i = 2, inner loop iterates (n-3) times, etc...

Total iterations: (n-1) + (n-2) + (n-3) + ... + 1 = [n * (n-1)]/2
