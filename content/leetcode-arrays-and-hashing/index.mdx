...
| Comparison | O(1) | O(1) | Each pair of elements is compared in constant time O(n) | No additional space is needed for comparisons O(1) |
...
### Solution 1: hashmap, track complement 1-pass
```python
