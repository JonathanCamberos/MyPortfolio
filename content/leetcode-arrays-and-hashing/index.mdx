...
| Bug | Error |
| --- | ----- |
| Find the Bug: (frequency count) |  Does not take into account frequency count. | 
...
### Find the Bug: Hashmap (unhashable type)
```python
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
        
        # space complexity: hashmap stores n tuple keys and lists of original strings of 26 length O(n)
        anaGroup = {}
...
### Find the Bug: Set (excludes duplicates)
```python
    def groupAnagrams(self, strs: List[str]) -> List[List[str]]:
