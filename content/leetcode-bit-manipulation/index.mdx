...
### Solution 1: HashSet Counting With Extra Space - Bit Manipulation/Bit Manipulation
```python
    def singleNumber(self, nums: List[int]) -> int:
        ...
        # 4. So XORing all numbers leaves only the unique number
...
### Solution 2: Bit Manipulation XOR Trick - Bit Manipulation/Bit Manipulation
```python
    def singleNumber(self, nums: List[int]) -> int:
        # Note:
        # XOR Approach
...
### Abstraction
Given an integer, find the hamming weight.
...
### Solution 1: Bit Manipulation Brian Kernighan’s Algorithm - Bit Manipulation/Bit Manipulation
```python
    def hammingWeight(self, n: int) -> int:
        # Note:
        # Brian Kernighan's Approach
        # 1. Each iteration removes the lowest set bit: n & (n-1)
        # 2. Count iterations until n becomes 0
        # 3. Efficient: runs in O(k) where k = # of set bits
...
### Solution 2: Bit Manipulation Shift and Mask - Bit Manipulation/Bit Manipulation
```python
    def hammingWeight(self, n: int) -> int:
        # Note:
        # Shift & Mask Approach
        # 1. Check each bit from LSB to MSB
        # 2. Increment count if the bit is 1
        # 3. Repeat until all 32 bits are processed
