...
to the user. A fault is usually defined as one component of the system deviating from its expectation.
...
##### Solution: Multi Machine Redundancy for High Availability
