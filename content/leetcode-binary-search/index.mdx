...
```python
    def minEatingSpeed(self, piles: List[int], h: int) -> int:
        ...
        # Greedy Start:
        # We need to determined the highest heuristic lower bound in order to do this efficiently.
        # We used 3 different perspectives to find our lower bound, 
        # we must use the networking analogy to determine the 3:

        # 1. Total bananas: Throughput -> Global Bandwidth
        #   - Based on total bananas being processed
        ...
        # Disregard Heuristics by bad choices:
        # 1. Average between piles
