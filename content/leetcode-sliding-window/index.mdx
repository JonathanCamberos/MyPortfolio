...
```python
    def lengthOfLongestSubstring(self, s: str) -> int:
        ...
        for right, char in enumerate(s):
            ...
            # if char already found, and previous char already
            # within bounds of sliding window -> old duplicate found
            if char in char_MRI and char_MRI[char] >= left:
                
                # move left index after oldest duplicate
                start = char_MRI[char] + 1
