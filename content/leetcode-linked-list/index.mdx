...
class LRUCache:
    ...
    def put(self, key: int, value: int) -> None:
        ...
        # remove current if exists and update
        ...
        # Push update/new node to MRU
        self._push_MRU(node)

        # Evict LRU if list over capacity
...
class LRUCache:
    ...
    def put(self, key: int, value: int) -> None:
        ...
        # If key does not exist, insert it and mark as recently used
        self.cache[key] = value
        
        # If capacity exceeded, remove least recently used (first in linked list)
        if len(self.cache) > self.capacity:
