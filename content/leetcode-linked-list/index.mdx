...
```python
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        while curr:
            ...
            # grab and set next and random deepCopy (may be None, so use .get() in case)
    ...
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        while curr:
            ...
            if curr.random:
                ...
                copy_node.random = memo[curr.random]
...
```python
    def copyRandomList(self, head: 'Optional[Node]') -> 'Optional[Node]':
        ...
        curr = head
        while curr:
            # grab deepCopy and assign random from original
            # to matching interweaved nodes
            if curr.random:
                curr.next.random = curr.random.next
            # iterate while skipping interweaved nodes
            curr = curr.next.next
