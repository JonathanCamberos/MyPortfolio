...
```python
    def reverseKGroup(self, head: Optional[ListNode], k: int) -> Optional[ListNode]:
        ...
        # head is tail of reversed group,
        # connect with processed sub list starting at curr
        head.next = self.reverseKGroup(curr, k)
        
        # prev is new head of reversed sub list
...
```python
    def reverseKGroup(self, head: Optional[ListNode], k: int) -> Optional[ListNode]:
        ...
        # Reverse sub linked list [start, end)
        # time complexity: O(k)
