---
title: "LeetCode: Graphs II Dijkstras"
...
## Output
Shortest path from one node to every other node in graph.
Differs from prim's and kruskal's which result in minimum spanning trees
