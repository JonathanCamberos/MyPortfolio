...
### Solution 1: Recursive with Memoization Top Down - 1D Dynamic Programming/DFS with Caching (Direct N) Top Down with Memoization
```python
...
### Solution 2: Iterative Bottom Up Array - 1D Dynamic Programming/Iterative Tabulation (Direct N) Bottom Up
```python
    def coinChange(self, coins: List[int], amount: int) -> int:
...
### Solution 1: i to N Recursive with Memoization Top Down - 1D Dynamic Programming/Track Multiple States per Index (Max Min Tracking)
```python
    def maxProduct(self, nums: List[int]) -> int:
        ...
        # 1. Recursive function dfs(i) returns (max_ending_here, min_ending_here)
        # 2. Explore Choices -> extend previous max, extend previous min, start new
        # 3. Memoization -> store results per index
...
### Solution 2: 0 to i Iterative Bottom Up Array - 1D Dynamic Programming/Track Multiple States per Index (Max Min Tracking)
```python
    def maxProduct(self, nums: List[int]) -> int:
...
### Solution 3: 0 to i Iterative Bottom Up Variables - 1D Dynamic Programming/Track Multiple States per Index (Max Min Tracking)
```python
    def maxProduct(self, nums: List[int]) -> int:
