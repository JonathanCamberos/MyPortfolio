...
```python
    def climbStairs(self, n: int) -> int:
        ...
        def dfs(i):
            ...
            # Explore Choices -> jump to either of next 1 or 2 steps
            left = dfs(i + 1)
            right = dfs(i + 2)
            ...
            # Sole Memo Return: only return upon first calculation for i
            # the rest will be grabbed from memo check
            return memo[i]
...
```python
    def climbStairs(self, n: int) -> int:
        ...
        def dfs(i):
            ...
            # Explore Choices -> arrive from either of previous 1 or 2 steps
            left = dfs(i - 1)
            right = dfs(i - 2)
...
```python
    def climbStairs(self, n: int) -> int:
        ...
        # 1. Base Set Up -> initial cases of prev2, prev1
        # 2. Iterate Explore 3 to nth -> dp[i] = prev2 + prev1
        # 3. Build -> fill ans iteratively
        # 4. Slide Window -> iterate variables
