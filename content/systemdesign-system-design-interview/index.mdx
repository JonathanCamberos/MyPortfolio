...
Client: A client is any software or device that initiates requests to a 
...
Domain Name: A domain name is the human-readable address of a resource on the 
...
3. Client -> Web Server: HTTP/JSON Request
...
HTML Response: An HTML response is an HTTP response whose body contains HTML 
