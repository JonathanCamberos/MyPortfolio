...
## Solution 3: Iterative DFS Pre Order Global Depth + Tuple (Subtree, Subtree Depth) Pass Down - Tree/DFS Pre Order Iterative One Sided Top Down
```python
...
## Solution 4: Iterative BFS Pre Order Full Level Global Depth + Completed Level Adds to Depth - Tree/BFS Pre Order Across Level For Level Size Based Grouping Full Across Top Down
```python
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        # Note:
