...
### Solution 1: DFS Post Order Recursive Carry Up Inverted Subtrees - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def invertTree(root: Optional[TreeNode]) -> Optional[TreeNode]:
        # Note:
...
### Solution 2: BFS Iterative Full Level Across Node Inversion - Tree/BFS Pre Order Across Level No Explicit Level Sized Grouping Full Across Top Down
```python
...
### Solution 1: DFS Post Order Recursive Carry Up Subtree Depth - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Pre Order Iterative Throw Down Root Depth (Root, Depth) - Tree/DFS Pre Order Iterative One Sided Top Down
```python
    # Note:
...
### Solution 3: BFS Iterative Total Number of Levels - Tree/BFS Pre Order Across Level For Level Size Based Grouping Full Across Top Down
```python
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        # Note:
...
### Solution 2: DFS Post Order Recursive Optimized Passed Tuple Diameter - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order: left -> right -> root
