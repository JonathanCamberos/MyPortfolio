...
### Solution 1: DFS Post Order Recursive Pass Upwards Subtree Diameter - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Post Order Recursive Optimized Passed Tuple (Edges, Diameter) - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order: left -> right -> root
...
### Solution 3: DFS Post Order Iterative Dictionary of Subtree Diameter - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
...
### Solution 4: DFS Post Order Iterative Dictionary of Subtree Tuple (Edges, Diameter) - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
