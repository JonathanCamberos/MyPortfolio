...
3. Linked Note Structure: Common in Binary Trees (TreeNode with left and right)
...
Will queue nodes for next level, count how many exist, and process
all nodes for that level by popping < count.
