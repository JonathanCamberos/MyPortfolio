...
### Solution 3: BFS Pre Order Iterative Full Level Each Node Inversion - Tree/BFS Pre Order Across Level No Explicit Level Sized Grouping Full Across Top Down
```python
...
### Solution 2: DFS Post Order Iterative Pass Up Subtree Depth - Tree/DFS Post Order Iterative Two Sided Bottom Up
```python
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order traversal: left -> right -> root
...
### Solution 3: DFS Pre Order Iterative Throw Down Tuple (Root, Depth) - Tree/DFS Pre Order Iterative One Sided Top Down
```python
    # Note:
...
### Solution 4: BFS Pre Order Iterative Full Level Each Node Count Level Number - Tree/BFS Pre Order Across Level For Level Size Based Grouping Full Across Top Down
```python
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        # Note:
...
### Solution 1: DFS Post Order Recursive Global Diameter + Local Edge Count Pass - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Post Order Recursive Local Diameter + Local Edge Count Pass - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order: left -> right -> root
...
### Solution 3: DFS Post Order Iterative Global Diameter + Dictionary Local Edge Count - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
...
### Solution 4: DFS Post Order Iterative Dictionary Local Diameter + Local Edge Count - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
...
### Solution 1: DFS Post Order Recursive Pass Height Upwards - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Post Order Recursive Pass Height Error Tuple Upwards - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        # Note:
        # DFS post order: left -> right -> root
...
### Solution 1: DFS Pre Order Recursive Pass Node Match Down - Tree/DFS Pre Order Recursive One Sided Top Down
```python
...
### Solution 2: BFS Iterative - Tree/BFS Pre Order Across Level No Explicit Level Sized Grouping Full Across Top Down
```python
    def isSameTree(self, p: Optional[TreeNode], q: Optional[TreeNode]) -> bool:
        # Note:
...
### Solution 1: DFS Pre Order Recursive - Tree/DFS Pre Order Recursive One Sided Top Down
```python
...
### Solution 3: DFS + Serialization String Matching - Tree/BFS Pre Order Across Level No Explicit Level Sized Grouping Full Across Top Down
```python
    def isSubtree(self, root: Optional[TreeNode], subRoot: Optional[TreeNode]) -> bool:
        # Note:
        # DFS pre order: root -> left -> right
