...
### Tree Application: BFS Iterative Level Size Based Grouping Full Across Top Down
...
### Tree Application: BFS Iterative No Explicit Level Sized Grouping Full Across Top Down
Traversal Order: Level by Level
...
### Tree Application: BFS Iterative Distance from Root Full Across Top Down
Traversal Order: Level by Level
...
### Tree Application: BFS Iterative Non-Standard Level Traversal Non Standard Full Across
...
### Solution 1: DFS Post Order Recursive Carry Up Inverted Subtrees - Tree/DFS Post Order Traversal
```python
    def invertTree(root: Optional[TreeNode]) -> Optional[TreeNode]:
        # Note:
...
### Solution 2: BFS Iterative Full Level Across Node Inversion - Tree/BFS Iterative No Explicit Full Level Processing
```python
...
### Solution 1: DFS Post Order Recursive Carry Up Subtree Depth - Tree/DFA Post Order Traversal
```python
...
### Solution 2: DFS Pre Order Iterative Throw Down Root Depth (Root, Depth) - Tree/DFA Pre Order Traversal
```python
    # Note:
...
### Solution 3: BFS Iterative Total Number of Levels - Tree/BFS Iterative Full Level Processing
```python
    def maxDepth(self, root: Optional[TreeNode]) -> int:
        # Note:
...
### Solution 1: DFS Post Order Recursive Pass Upwards Subtree Diameter - Tree/DFS Post order Traversal
```python
...
### Solution 2: DFS Post Order Recursive Optimized Passed Tuple Diameter - Tree/DFS Post order Traversal
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order: left -> right -> root
