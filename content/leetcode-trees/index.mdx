...
### Solution 1: DFS Post Order Recursive Global Max Diameter + (Subtree Edge Count) Pass Up - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Post Order Recursive Tuple (Subtree Diameter, Subtree Edge Count) Pass - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
        # Note:
        # DFS post order: left -> right -> root
...
### Solution 3: DFS Post Order Iterative Global Diameter + Dictionary (Subtree Edge Count) - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
...
### Solution 4: DFS Post Order Iterative Global Diameter + Dictionary (Subtree Diameter + Subtree Edge Count) - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def diameterOfBinaryTree(self, root: Optional[TreeNode]) -> int:
...
### Solution 1: DFS Post Order Recursive Global Error Marker + Local Height Pass - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
...
### Solution 2: DFS Post Order Recursive Tuple (Local Build Bool, Local Height) Pass - Tree/DFS Post Order Recursive Two Sided Bottom Up
```python
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        # Note:
        # DFS post order: left -> right -> root
