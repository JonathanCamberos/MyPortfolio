...
### Solution 1: DFS Post Order Recursive Pass Height Upwards - Tree/DFS Post order Traversal
```python
...
### Solution 2: DFS Post Order Recursive Pass Height Error Tuple Upwards - Tree/DFS Post order Traversal
```python
    def isBalanced(self, root: Optional[TreeNode]) -> bool:
        # Note:
        # DFS post order: left -> right -> root
...
### Solution 1: DFS Pre Order Recursive Pass Node Match Down - Tree/DFS Pre order Traversal
```python
